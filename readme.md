...
2. Выберите директорию, где будут находиться файлы проекта.  
   Скопируйте в неё файлы проекта удобным для вас способом.  
   Для клонирования с помощью Git Bash выполните команду:  
   ```
...
6. Работая в корневой папке проекта, запустите компиляцию командой `mvn -c clean compile`
